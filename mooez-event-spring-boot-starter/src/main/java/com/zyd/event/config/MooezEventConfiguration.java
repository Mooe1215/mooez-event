package com.zyd.event.config;

import com.zyd.event.action.apply.consumer.IMooezEventHandler;
import com.zyd.event.action.core.consumer.DefaultCoreConsumerHandler;
import com.zyd.event.action.core.producer.DefaultCoreProducerHandler;
