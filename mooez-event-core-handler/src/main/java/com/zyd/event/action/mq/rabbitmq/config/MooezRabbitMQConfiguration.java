package com.zyd.event.action.mq.rabbitmq.config;

import com.zyd.event.action.apply.consumer.IMooezEventHandler;
import com.zyd.event.action.apply.consumer.MooezEvent;
import com.zyd.event.action.mq.rabbitmq.consumer.RabbitMqConsumerListener;
import com.zyd.event.action.mq.rabbitmq.producer.RabbitMqProducerHandler;
import com.zyd.event.commons.base.Constants;
import com.zyd.event.commons.utils.ApplicationUtils;
